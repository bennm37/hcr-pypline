...
cell_data = project_to_midline(cell_data, midline, contour, mesoderm_cutoff=50)
...
plot_gradients(["brk", "dpp", "pmad", "nuclear"], ["hcr", "hcr", "staining", "nuclear"], cell_data[cell_data["endoderm"]])
plt.show()
