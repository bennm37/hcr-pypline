...
def point_annotator(
    ...
    # seperate channels
    s = stack.shape
    # stack = stack.reshape(4, s[0]//4, s[1], s[2])
...
if __name__ == "__main__":
    point_annotator(
        "data/TdEmbryo_Hoechst_pMad488_dpp546_brk647_2024_05_06__18_26_23(41).czi",
        ["L1", "L2", "L3", "L4", "L5", "L6"],
    )
    # point_annotator(
    #     "/Users/nicholb/Documents/segmentation/Germband_Extension/Td_Germband_Hoechst_pMad555_20240214_Embryo01.tif",
    #     ["head", "tail", "left fin", "right fin"],
    # )
