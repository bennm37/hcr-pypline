...
def project_to_midline(cell_data, midline, contour, n_points=1000, mesoderm_cutoff=50):
    ...
    cell_data["endoderm"] = cell_splines_offsets < mesoderm_cutoff
    cell_data["ectoderm"] = cell_splines_offsets > mesoderm_cutoff
    return cell_data
